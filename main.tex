...
%--- (S7) technician load definition ---
& L_{t,d} = \sum_{j \in \mathcal{J}} \sum_{k \in \mathcal{K}} \tau_j \, y_{j,t,k,d}, \quad \forall\, t,d
    && \text{(Technician-day load)} \label{eq:tech_load}\\[4pt]
